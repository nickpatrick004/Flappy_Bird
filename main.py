...
# bottom obstacle is jacked
def display_obstacle(height):
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, 0, OBSTACLE_WIDTH, height))
    bottom_obstacle_top = height + 150
    bottom_obstacle_height = 635 - bottom_obstacle_top
    pygame.draw.rect(SCREEN, OBSTACLE_COLOR, (obstacle_x, bottom_obstacle_top, OBSTACLE_WIDTH, bottom_obstacle_height))
